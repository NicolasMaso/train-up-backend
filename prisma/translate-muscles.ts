...
// Complete muscle mapping including secondary muscles
const muscleMap: Record<string, string> = {
  ...
  // Secondary muscles (common in API responses)
...
function translateMuscles(musclesStr: string | null): string | null {
  if (!musclesStr) return null;
